...
// 1. İd-si 11070 olan ölkəni tapın və consoledə yazdırın.

// example.forEach((element) => {
//     if(element.id === 11070){
//         console.log(element.shipAddress.country);
        
//     }
// })

// 2.Ölkəsi Germany olan obyekti tapın və consoledə yazdırın.

// example.forEach(element => {
//     if(element.shipAddress.country == "Germany") {
//         console.log(element);
//     }
// })
...
// 3.ID-i 11065 olan elementin shipName , Country və City dəyərini tapın və consoledə yazdırın.

// example.forEach(element => {
//     if(element.id === 11065){
//         console.log(element.shipName, element.shipAddress.country, element.shipAddress.city);    
//     }
// })
// 4.ID-i 10550 olan obyektin neçə növdə satış edildiyini tapın və consoledə yazdırın. (details sayı)

// example.forEach(element =>{
//     if(element.id ===10550) {
//         console.log(element.details.length);
        
//     }
        
// })

// 5.ID-i 10310 olan obyektin toplam qazancını tapın consoleda yazdırın (discount daxil)1

example.forEach(element => {
    if(element.id === 10310 ){
        let toplamQazanc = 0;
        element.details.forEach(item => {
            toplamQazanc += item.unitPrice - item.discount;
        })   
        console.log(toplamQazanc);     
    }
})